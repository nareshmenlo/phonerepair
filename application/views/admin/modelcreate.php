...
<fieldset class="scheduler-border">
    <legend class="scheduler-border">Add New Model</legend>

   
    <form role="form" id="modelsform" method="post" action="<?php echo base_url('models/create'); ?>" enctype="multipart/form-data" >
 <?php if(validation_errors()!=""){?>
    ...
    <?php } ?>
        ...
        <div class="form-group">
          <img id="blah" width="200px" height="200px" src="#" alt="model image" onerror="imgError(this);" />
        </div>
